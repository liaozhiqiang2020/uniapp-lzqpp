<template>
	<view>
		...
		<swiper style="border-radius: 10upx;overflow: hidden;" class="screen-swiper" :class="dotStyle?'square-dot':'round-dot'" :indicator-dots="true" :circular="true"
		 :autoplay="true" interval="5000" duration="500">
			<swiper-item style="border-radius: 10upx" v-for="(item,index) in swiperList" :key="index"
			>
		...
		data() {
			return {
				...
				swiperList: [{
					id: 0,
					type: 'image',
					url: 'https://dss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2583035764,1571388243&fm=26&gp=0.jpg'
				}, {
					id: 1,
					type: 'image',
					url: 'https://dss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=2583035764,1571388243&fm=26&gp=0.jpg',
