<script>
	...
	export default {
		...
		onLaunch: function() {
			...
			// 	// });
			// } else {
			// 	that.login(uni.getStorageSync('userInfo'));
			// }
			// if (!uni.getStorageSync('img_uploadState')) {} else {
			// 	that.img_upload(uni.getStorageSync('img_uploadState'));
			// }
			let that = this
			wx.login({
				success: function(res) {
					...
					wx.request({
						url: that.baseUrl + '/weixin/login?code=' + res.code,
						data: {},
						method: 'GET',
						success: function(res) {
